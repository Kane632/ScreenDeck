...
if (A_IsCompiled)
{
	if (!DirExist(PathToImagesFolder))
	{
		DirCreate(PathToImagesFolder)
	}

	if (!FileExist(".\Images\ScreenDeck.ico"))
	{
		FileInstall(".\Images\ScreenDeck.ico", ".\Images\ScreenDeck.ico")
	}

	if (!FileExist(".\Images\SquareBtn.png"))
	{
		FileInstall(".\Images\SquareBtn.png", ".\Images\SquareBtn.png")
	}
}
